	...
	<div class="row">
		<div class="row-block">
			...
			<div class="form-group">
				<button class="btn btn_primary" type="submit">{{__('user_messages.reset_password')}}</button><button class="btn btn_primary"><a href="{{route('login')}}">{{__('user_messages.login')}}</a></button>
			</div>
		</div>
	</div>
</form>
