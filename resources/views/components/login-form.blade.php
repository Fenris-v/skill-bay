<form class="form Authorization" action="{{route('auth')}}" method="post">
	...
	<div class="row">
		<div class="row-block">
			...
			<x-user-field type="password"  name="password" title="{{__('user_messages.password')}}" id="password" placeholder="{{__('user_messages.placeholder_password_login')}}">Пароль</x-user-field>
