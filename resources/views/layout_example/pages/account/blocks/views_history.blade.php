...
<div class="Account-group">
    <div class="Account-column Account-column_full">
        @include('layouts.blocks.header_line', ['title' => 'История просмотров'])
...
{{--                                <img src="/assets/img/icons/card/bookmark.svg" alt="bookmark.svg"/></a>--}}
{{--                            <a class="Card-btn" href="#">--}}
...
{{--                <div class="Card-content">--}}
{{--                    <strong class="Card-title">--}}
{{--                        <a href="#">Barand New Phone Smart Business</a>--}}
{{--                    </strong>--}}
{{--                    <div class="Card-description">--}}
{{--                        <div class="Card-cost">--}}
{{--                            <span class="Card-priceOld">$115.00</span>--}}
...
{{--            </div>--}}
        ...
        <div class="Account-editLink Account-editLink_view"><a href="historyview.html">Перейти
                на полный список</a>
        </div>
    </div>
</div>
